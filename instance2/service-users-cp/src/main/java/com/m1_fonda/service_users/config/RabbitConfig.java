...
public class RabbitConfig {
    ...
    public TopicExchange userExchange(){
        return new TopicExchange("userCopyExchange");
    }
    ...
    // declaration de la file d'attente du producteur userService si elle n'a pas encore ete creer
    @Bean 
    ...
    public Binding binding(TopicExchange userExchange,Queue userQueue){
        return BindingBuilder.bind(userQueue).to(userExchange).with("userCopy.create");
    }
}
